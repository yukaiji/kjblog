...
(function ($) {
	...
	$('nav.main-navigation').meanmenu({
		meanMenuClose: '<img class="black" href="../static/img/icons/icon-close.png" alt="close icon"><img class="white" href="../static/img/icons/icon-close-white.png" alt="close icon">',
